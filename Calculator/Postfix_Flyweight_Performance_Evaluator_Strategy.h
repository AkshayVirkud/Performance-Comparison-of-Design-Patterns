//==============================================================================
/**
* @file       Postfix_Flyweight_Performance_Evaluator_Strategy.h
*
* $Id: Postfix_Flyweight_Performance_Evaluator_Strategy.h 819 2011-01-17 15:24:45Z hillj $
*
* Honor Pledge:
*
...
#ifndef _POSTFIX_FLYWEIGHT_PERFORMANCE_EVALUATOR_STRATEGY_H_
#define _POSTFIX_FLYWEIGHT_PERFORMANCE_EVALUATOR_STRATEGY_H_
...
/**
* @class Postfix_Flyweight_Performance_Evaluator_Strategy
*
* Basic implementation of a Postfix_Flyweight_Performance_Evaluator_Strategy.
*/

class Postfix_Flyweight_Performance_Evaluator_Strategy : public Expr_Evaluator_Strategy
{
public:
	/// Default constructor.
	Postfix_Flyweight_Performance_Evaluator_Strategy (void);

	/// Destructor.
	virtual ~Postfix_Flyweight_Performance_Evaluator_Strategy (void);
...
#endif   // !defined _POSTFIX_FLYWEIGHT_PERFORMANCE_EVALUATOR_STRATEGY_H_
