...
*
* $Id: Flyweight_Expr_Command_Factory.h 819 2011-01-17 15:24:45Z hillj $
*
* Honor Pledge:
*
...
*
* Basic implementation of a Flyweight_Expr_Command_Factory.
*/
...
private:
	...
	OpenParanthesis_Command * openParanthesis_;
	ClosedParanthesis_Command * closedParanthesis_;
};