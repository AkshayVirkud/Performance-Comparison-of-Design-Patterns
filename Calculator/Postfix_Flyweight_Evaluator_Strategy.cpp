...
//
// ~Postfix_Flyweight_Evaluator_Strategy
// Destructor which is called when Postfix_Flyweight_Evaluator_Strategy objects are destroyed (deallocated).
//
Postfix_Flyweight_Evaluator_Strategy::~Postfix_Flyweight_Evaluator_Strategy()
{
...
//
bool Postfix_Flyweight_Evaluator_Strategy::parseExpr(const std::string & infix, int &result)
{
...
//
bool Postfix_Flyweight_Evaluator_Strategy :: convertInfixToPostfix (const std::string & infix, Expr_Command_Factory & factory, Array <Expr_Command *> & postfix)
{
...
//
int Postfix_Flyweight_Evaluator_Strategy :: getOperatorPriority(std::string objOperator)
{
